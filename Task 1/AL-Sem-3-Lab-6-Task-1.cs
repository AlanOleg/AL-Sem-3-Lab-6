...
class Program
{
    ...
    private const string ApiKey = "af9ec8c0d61361467683fe280018f3e7"; // API ключ для доступа к OpenWeather API
    ...
    private static async Task<Weather?> GetWeatherData(string url)
    {
        try
        {
            ...
            {
                Console.WriteLine("Страна не найдена"); // Логирование проблемы с данными
            }
        }
